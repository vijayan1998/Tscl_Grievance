...
class _MyReportsContentState extends State<MyReportsContent> {
  ...
  grievances = decryptedJsonList.map((item) {
    return Grievance(
      ...
      grievanceMode: item['grievance_mode']??'', // New field added
 ...
 grievances.sort((a, b) => DateTime.parse(b.createdAt).compareTo(DateTime.parse(a.createdAt)));
                          ...
                          Row(
                            ...
                            children: [
                              CircleAvatar(
                                ...
                                child:Text(
                                grievance.complaint.substring(0,1).toUpperCase(),  style: const TextStyle(
                                fontSize: 24,
